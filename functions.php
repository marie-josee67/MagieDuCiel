<?php 
    ...
    function ciel_styles() : void{
        ...
        //paramètres; identifiant, chemin, dépendance, écran (screen, all...) ranger dans l'ordre du index.html 
...
function a_propos_image_points() {
    ...
    $image_url = get_template_directory_uri() . '/assets/img/shapes/dots_rectengular.png';
    $custom_css = "
